...
?>
                ...
                <p><img src="<?php echo $i; ?>" alt="This is me" class="image img-circle img-responsive" style="width:50%;height:50% ; position:relative;top:60px;" /></p>
              </div>
              <div class="col-sm-6">
                <p><h3>  
<?php
...
<form method="POST" action="insertD.php">
  ...
  TeamId:<input type="number" name="tId" id="tId"><br>
